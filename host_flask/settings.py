...
# Django settings for host_flask project.
...
SECRET_KEY = 'ol6%f)=14@jmpb5nqqwml!x)a=50n+!c5nxpvt$igdtw8y*_zc'
...
ROOT_URLCONF = 'host_flask.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'host_flask.wsgi.application'
